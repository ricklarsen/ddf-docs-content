	...
	<executions>
	    <execution>
	        ...
	        <configuration>
	            ...
	            <!--
	            Location of the features.xml file. If it references properties that need to be filtered, such as `version`, it will need to be
	            ...
	            <finalName>{ddf-branding-lowercase}-ifis-{ddf-version}</finalName>
	        </configuration>
	    </execution>
    </executions>
</plugin>
