...
. Create an OSGi descriptor file to communicate with the OSGi Service Registry (described in xref:developing:devguidelines/osgi-basics,adoc[OSGi Basics]). Export the service to the OSGi registry and declare service properties.
+
