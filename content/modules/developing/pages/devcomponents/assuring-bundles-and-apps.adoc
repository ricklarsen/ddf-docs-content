...
[source,subs=attributes+]
----
~ $ jarsigner -keystore keystore.jks -keypass shield -storepass password  catalog-app-{version}.kar selfsigned
----
...
[source,subs=attributes+]
----
~ $ jarsigner -verify -verbose -keystore keystore.jks catalog-app-{version}.kar
...
smk     6768 Wed Sep 17 17:13:58 MST 2014 repository/{ddf-branding-lowercase}/catalog/security/catalog-security-logging/{version}/catalog-security-logging-{version}.jar
