...
[source,subs=attributes+]
----
~ $ jarsigner -keystore keystore.jks -keypass shield -storepass password  catalog-app-{ddf-version}.kar selfsigned
----
...
[source,subs=attributes+]
----
~ $ jarsigner -verify -verbose -keystore keystore.jks catalog-app-{ddf-version}.kar
...
smk     6768 Wed Sep 17 17:13:58 MST 2014 repository/{ddf-branding-lowercase}/catalog/security/catalog-security-logging/{ddf-version}/catalog-security-logging-{version}.jar
