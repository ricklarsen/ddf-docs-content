...
image::XmlInputTransformer_configuration.png[XML Input Transformer Configuration]

.`XMLInputTransformer` `SaxEventHandlerDelegate` Configuration
image::XmlInputTransformer_saxeventhandlerdelegate.png[XML Input Transformer / Sax Event Handler Delegate]
