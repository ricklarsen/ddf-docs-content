...
This is one way to ingest into the catalog, for a complete list of the different methods, see xref:managing:datamanagement/ingesting_data[Ingesting Data].
