...
If {branding} is being installed on a remote server that has no user interface, the hostname needs to be updated in the configuration files and certificates.
