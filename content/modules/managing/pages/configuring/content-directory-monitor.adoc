...
[NOTE]
====
If there's a metacard that points to a resource outside of the CDM, then you must configure the xref:architectures:url-resource-reader.adoc[URL Resource Reader] to be able to download it.
====
