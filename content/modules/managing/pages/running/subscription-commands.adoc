...
----
{branding-lowercase}@local>subscriptions:list
...
[source,subs=attributes]
----
{branding-lowercase}@local>subscriptions:list "my.contextual.id.v20|http://172.18.14.169:8088/mockCatalogEventConsumerBinding?WSDL"
...
[source,subs=attributes]
----
{branding-lowercase}@local>subscriptions:list "my*"
...
{branding-lowercase}@local>subscriptions:list "*json*"
...
{branding-lowercase}@local>subscriptions:list "*WSDL"
...
[source,subs=attributes]
----
{branding-lowercase}@local>subscriptions:list -f "(|(subscription-id=*json*) (subscription-id=*v20*))"
...
[source,subs=attributes]
----
{branding-lowercase}@local>subscriptions:list -f "(&(subscription-id=*json*) (subscription-id=*172.18.14.169*))"
...
[source,subs=attributes]
----
{branding-lowercase}@local>subscriptions:delete "my.contextual.id.json|http://172.18.14.169:8088/services/json/local/event/notification"
...
[source,subs=attributes]
----
{branding-lowercase}@local>subscriptions:delete "my*"
...
{branding-lowercase}@local>subscriptions:delete "*json*"
...
[source,subs=attributes]
----
{branding-lowercase}@local>subscriptions:delete *
...
[source,subs=attributes]
----
{branding-lowercase}@local>subscriptions:delete -f "(&(subscription-id=*WSDL) (subscription-id=*172.18.14.169*))"
