...
The metadata common to all these document types, for example,, creation date, author, last modified date, etc., is extracted and used to create the catalog record.
