...
----
# This defines the separator that is used when the expansion string contains multiple
# values - each is separated by this string. The expanded string is split at the
