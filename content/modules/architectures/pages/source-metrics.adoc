...
Therefore, it is possible to access metrics data for sources renamed months ago until {branding} is reinstalled or the metrics data is deleted from the `{home_directory}/data/metrics` directory.
